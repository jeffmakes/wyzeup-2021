...
<title>Wyze Up - How it works</title>
...
<div id="content">
	...
	<div id="contentrightmain">
	  ...
	  <div id="contentright">
		...
		<img src="wyzeup_images/how-it-works.gif" title="How it Works" width="518" height="32">
            <p><a name="skipnav"></a>Wyze-up contains a number of different situations, covering things that could happen to you in real life.  Each situation is described in words that you will find easy to understand. You will also probably have seen the games-style console, or something very like it, before.</p>
            <p>When you are ready to begin, click on <?php if(isset($_SESSION['session_schoolemail'])){  ?><a href="javascript:Popup_Scenario();">Go to Wyze-up Console</a> <?php }else { ?><a href="login.php">Go to Wyze-up Console</a><?php } ?> on the tool bar on the left.</p>
            <p>When the Wyze-up Console appears, first choose a situation from the drop-down menu at the top.</p>
            <p>You will then see the first part of the story on the screen in the middle of the console.  Read through it (you may have to scroll down on some parts) and at the end of the first part of the scenario the character in the story will do, say or think something.  You must decide whether the situation or choice presented is Wyze or Unwyze.  If you think that it is all right you should click the green Wyze button. If you think it is not right or potentially dangerous, then click the red Unwyze button.</p>
			<p>If you are right, the first block on colour the bar to the right of the story will light up. If you are wrong it will not.</p>
			<p>Click the Next button and the next part of the story will appear.</p>
			<p>Now do the same things again; read the next bit of story and again make your Wyze or Unwize choice.</p>
			<p>Keep doing this until you reach the end of the story.</p>
			<p>Now, have fun and try to think what you would do or say or think if these things happened to you.</p>
	    </div>
	  </div>
	</div>
