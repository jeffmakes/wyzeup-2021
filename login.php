...
function ValidateMember(){
	if(TextValidate(document.frmmember.memberusername," the Username")==false){ return false;}
	if(TextValidate(document.frmmember.memberpassword," the Password")==false){ return false;}
	document.frmmember.action="loginprocess.php";
	...
	<div id="contentrightmain">
	  ...
	  <div id="contentright">
		<div id="contentrightbox">
		  ...
		  <img src="wyzeup_images/member-login.jpg" title="Login"  width="518" height="32" alt="Login">
		  <p>&nbsp;</p>
		  <div id="contentloginbox">
		 <div id="formlayerapplication">
					<form action="" name="frmmember" method="post">
					
					<label for="memberu">email address:</label>
					<input name="memberusername" type="text" id="memberusername" onClick="javascript:clear_membertext(1);" value="email address" />
					<br>
					<label for="memberp">password:</label>
					<input name="memberpassword" type="password" id="memberpassword" onKeyPress="javascript:return handleKeyPressMember(event);" onClick="javascript:clear_membertext(2);" value="password" />
					</form>
					
				  <a href="#" onClick="ValidateMember();" title="Login"><img src="wyzeup_images/button-login-on.jpg" width="71" height="24" vspace="5" border="0" alt="Login" title="Login"></a>
				<br /><br /><div align="left">New User? &nbsp;<a href="online_application.php">Sign Up</a></div><br />
				
				<?php  
 							if(isset($_GET["status"]) && $_GET["status"]=='invalid') {
								$msg = "Invalid username and password.";
							} else if(isset($_GET["status"])&& $_GET["status"]=='login') {
								$msg = "You need to login to access this page.";
							} else if(isset($_GET["status"])&& $_GET["status"]=='logout') {
								$msg = "You have successfully logged out.";
							} 
							echo "<span class='style2'>".$msg."</span>";
				?>
		   </div>
		  </div>
		</div>
