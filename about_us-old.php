...
<html><!-- InstanceBegin template="/Templates/DDA Templates.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<!-- InstanceBeginEditable name="doctitle" -->
<title>Wyze Up - About us</title>
<!-- InstanceEndEditable --><link href="wyzeup_css/wyzeup.css" rel="stylesheet" type="text/css">
...
<div id="content">
	...
	<div id="contentrightmain">
		...
		<img src="wyzeup_images/about-us.gif" title="About Us" width="518" height="32">
            <p><a name="skipnav"></a>Wyze-up is a web-based, interactive program to help educate children by growing their awareness of what is a danger sign or a potentially unsafe situation. </p>
            <p>The site provides a number of different scenarios covering typical real-life situations and is designed to complement teaching of the PSHCE curriculum.  Each scenario is described in language that children between five and seven years old will easily understand and is presented on a simulated games-style console. </p>
            <p>The program is available to schools on an annual, unlimited user licensed basis for only &pound;19:95 per annum. E-learning credits may also be used if preferred.</p>
            <p>For each scenario, up to five situation developments are described. After reading each development the child has to decide whether the decision that the character has taken is Wyze or Un-wyze. Having made the decision, the next development in the scenario can be selected.  Correctly identifying the Wyze or Un-wyze decisions by the character moves a graduated progress bar.</p>
			<p>Moving through each of the scenarios requires manual selection on the console, enabling teacher involvement and discussion opportunities.</p>
	   </div>
	    </div>
...
<div id="footer">
				<div id="footerboxleft">
						...
						<a href="about_us.php" title="About Us" accesskey="2">About us</a> | 
						<a href="how_it_works.php"  title="How it works" accesskey="3">How it works</a> | 
						<a href="pshce_curriculam.php"  title="PSHCE curriculum" accesskey="4">PSHCE curriculum</a> | 
						<a href="contact_us.php"  title="Contact Us" accesskey="5">Contact</a> | 
						<a href="sitemap.php" title="Site map" accesskey="6">Site map</a> |
						<a href="accessibility.php"  title="Accessibility" accesskey="0">Accessibility</a> <br>
						&copy; Copyright <?php echo $curdate[2]; ?> - Wyze Up - <a href="http://www.selesti.com/" target="_blank">Site by Selesti</a>	<br/>	  
		 				<a href="http://validator.w3.org/check?uri=http://www.wyzeup.co.uk/staging/v4/<?php echo $file; ?>" title="XHTML">XHTML</a>, <a href="http://jigsaw.w3.org/css-validator/validator?uri=http://www.wyzeup.co.uk/staging/v4/wyzeup_css/wyzeup.css" title="CSS">CSS</a>, <a href="http://webxact.watchfire.com/" title="508">508</a>&nbsp;&nbsp;
	</div>		  
	  </div>
</div>
<!-- END div-main //-->
