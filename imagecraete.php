...
/*
    ...
    This script generates PNG images of text, written in the font/size that you specify. These PNG images are passed
    back to the browser. Optionally, they can be cached for later use. If a cached image is found, a new image will not be generated,
...
// clean up text
//if(empty('i love india'))
   // fatal_error('Error: No text specified.') ;
    
$text = 'i love india'; // $row["scenario_name"] ; // $_GET['text'] ;
