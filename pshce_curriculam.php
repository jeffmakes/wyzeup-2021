...
<title>Wyze Up - PSHCE curriculam</title>
...
<div id="content">
	...
	<div id="contentrightmain">
	  ...
	  <div id="contentright">
		...
		<img src="wyzeup_images/pshce-curriculum.gif" title="PSHCE curriculam" width="518" height="32">
            <p><a name="skipnav"></a>Wyze-up is designed to support Key Stage 1 PSHE by enabling pupils to work individually or in groups.</p>
            <p>The format allows pupils to work on their own or under the formal or informal guidance of the teacher.</p>
            <p>Wyze-up works equally well whether PSHE is taught as a subject in its own right or: </p>
          
		   <ul class="txtlink4"> 
				<li class="txtlink4">Through other subjects</li>
				<li class="txtlink4">Through special time set aside</li>
				<li class="txtlink4">By creating special opportunities for children to take responsibility.</li>
			</ul>
		</div>
	  </div>
	</div>
