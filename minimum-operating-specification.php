...
<div id="content">
	...
	<div id="contentrightmain">
	  ...
	  <div id="contentright">
		...
		<img src="wyzeup_images/minimum-operating-specifica.gif" title="Minimum Operating Specification" width="518" height="32">
            <p><a name="skipnav"></a><span class="title">Hardware</span><br>
PC - Intel Pentium III / 1Ghz Celeron Processor or equivalent 128Mb RAM</p>
            <p> <span class="title">Software</span><br>
              PC - Windows 98/2000 &amp; XP<br>
          Apple MAC - MAC OS X</p>
            <p> <span class="title1">Web browsers</span><br>
              <span class="title">PC</span><br>
              Internet Explorer 6, 5.5, and 5<br>
              Mozilla Firebird 0.7<br>
              Mozilla Firefox 0.8<br>
              Netscape Navigator 7.0<br>
              Opera 7.5<br>
          Lynx</p>
  <p> <span class="title">Mac</span><br>
              Safari 1.0.1<br>
              Internet Explorer 5.2<br>
              Mozilla Firebird 0.7<br>
          Internet Explorer</p>
            <p> <span class="title">Display</span><br>
              SVGA or above<br>
          Display at 800 x 600 or above</p>
		</div>
      </div>
	</div>
...
<div id="footer">
				<div id="footerboxleft">
                        ...
                        <a href="minimum-operating-specification.php" title="Minimum Operating Specification" accesskey="7">Minimum Operating Specification</a> |
						<a href="accessibility.php"  title="Accessibility" accesskey="0">Accessibility</a>
