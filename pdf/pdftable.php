...
$pdf->InvoiceClientName(array("Client 	: ".stripslashes($client_name)),"");


# To dispaly the Client Address

$schooldata[]    = stripslashes($row_wyze["school_address1"]);
$schooldata[]    = stripslashes($row_wyze["school_address2"]);
$schooldata[]    = stripslashes($row_wyze["school_city"]);
$schooldata[]    = stripslashes($row_wyze["school_country"]);
$schooldata[]    = stripslashes($row_wyze["school_zipcode"]);
$schooldata[]    = "Tel :".stripslashes($row_wyze["school_phone"]);
$schooldata[]    = "E-Mail : ".stripslashes($row_wyze["school_email"]);
...
$addressval1 = array($row_wyze["school_address1"],'Wyzeup');
$addressval2 = array($row_wyze["school_address2"],'PO Box 3324');
$addressval3 = array($row_wyze["school_city"],'Norwich');
$addressval4 = array($arrcountries[$row_wyze["school_country"]],'NR7 7FQ');
