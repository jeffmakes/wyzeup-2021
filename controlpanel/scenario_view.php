<?php 
	...
	if($_GET["scenario_id"]!="0" && $_GET["action"]=="delete"){ # Delete Operation
		 mysql_query("UPDATE wyzeup_scenarios SET scenario_isdeleted=1 WHERE scenario_id=".$_GET["scenario_id"]);
		 header("Location:scenario_view.php");
	}
	//$sql = "SELECT scenario_id,scenario_name,CONCAT('<a href=question_view.php?action=view&scenario_id=',scenario_id,'>View</a>') as question, IF(scenario_status,'Active','InActive') as scenario_status,CONCAT('<a href=scenario.php?action=edit&scenario_id=',scenario_id,'>Edit</a> | <a href=scenario.php?action=view&scenario_id=',scenario_id,'>View</a>  | <a href=# onClick=Delete(scenario_id=',scenario_id,')>Delete</a>') as action FROM wyzeup_scenarios WHERE scenario_isdeleted = 0";
	$sql = "SELECT scenario_id,scenario_name, IF(scenario_status,'Active','InActive') as scenario_status,CONCAT('<a href=scenario.php?action=edit&scenario_id=',scenario_id,'>Edit</a> | <a href=scenario.php?action=view&scenario_id=',scenario_id,'>View</a>  | <a href=# onClick=Delete(scenario_id=',scenario_id,')>Delete</a>') as action FROM wyzeup_scenarios WHERE scenario_isdeleted = 0";
	$_SESSION['ex3']=$sql;
?> 
<html>
<head>
...
function Delete(id) {
	if(confirm("Do you want to delete the Scenario?")) {	
		document.form1.action="scenario.php?action=delete&scenario_id="+id;
    ...
    <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<table width="95%" border="0" align="center" cellpadding="4" cellspacing="1">
              <tr>
                <td align="left" class="h1">List of Scenarios</td>
                <td align="left" class="paragraph"><a href="scenario.php">Click here to add a Scenario</a></td>
              </tr>
              <tr>
