      ...
      <tr>
        <td valign="top">
				 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     <td width="25%" height="20"><h1 class="h1"> List of Staffs </h1></td>
                     <td width="34%" class="paragraph"><div align="right"><a href="users.php">Click here to add a User</a></div>
                    </td>
                     <td width="41%" class="paragraph">&nbsp;</td>
                   </tr>
