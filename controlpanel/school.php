...
function validate() {
	...
	if(TextValidate(form_name.school_zipcode,"the postcode")==false){return false;}
    ...
    <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top">          <table width="95%" border="0" align="center" cellpadding="4" cellspacing="1">
              <tr>
                <td align="left"><span class="h1"><?php if($_GET["action"]!="view"){ echo "Add/Modify"; } else { echo "View"; }?> School Details </span></td>
				    ...
				    <table width="100%"  border="0" cellspacing="1" cellpadding="4">
				      ...
				      <tr>
						...
						<?php //if($_GET['action'] == ) { ?> 
					     ...
					     <tr>
                           <td align="right" valign="top" bgcolor="#EFEFEF" class="paragraph"><span class="mandatory">*</span> Postcode : </td>
                           <td valign="top" bgcolor="#FFFFFF" class="paragraph">
				  ...
				  <?php } else {?>	  
				    ...
				    <table width="100%"  border="0" cellspacing="1" cellpadding="4">
				      ...
				      <tr>
				        ...
				        <td bgcolor="#FFFFFF" valign="top" class="paragraph"><?php echo $school->school_contactperson_position;?></td>
				        </tr>
				      <tr>
				        <td align="right" valign="top" bgcolor="#EFEFEF" class="paragraph">Start Date : </td>
				        <td bgcolor="#FFFFFF" valign="top" class="paragraph"><?php echo $school->school_startdate; //$date1=explode("-",trim($school->school_startdate)); $startdate=$date1[2]."-".$date1[1]."-".$date1[0]; echo $startdate;?></td>
				        </tr>
				      <tr>
				        <td align="right" valign="top" bgcolor="#EFEFEF" class="paragraph">End Date : </td>
				        <td bgcolor="#FFFFFF" valign="top" class="paragraph"><?php echo $school->school_enddate; //$date2=explode("-",trim($school->school_enddate));		$enddate=$date2[2]."-".$date2[1]."-".$date2[0]; echo $enddate;?></td>
				        </tr>
				      <tr>
				      ...
				      <tr>
                        <td align="right" valign="top" bgcolor="#EFEFEF" class="paragraph">Postcode : </td>
				      ...
				      <tr>
				        ...
				        <td bgcolor="#FFFFFF" valign="top" class="paragraph"><?php echo $school->school_invoice_to;?></td>
				        </tr>
				      <tr>
				        <td align="right" valign="top" bgcolor="#EFEFEF" class="paragraph">Proforma Required : </td>
				        <td bgcolor="#FFFFFF" valign="top" class="paragraph"><?php echo $school->school_proforma_invoice;?></td>
				        </tr>
				      <tr>
